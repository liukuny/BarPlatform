...
CMD5 md5;
string csMd5Buffer=md5.MD5("a string");
...
public:
	string MD5( const char *szText);
	string MD5( const void *pBuffer, int nBufLen);
	// 文件
	string MD5File( const char *szFileName);
private:
