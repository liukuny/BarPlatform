...
BEGIN_MESSAGE_MAP(CBarPlatformApp, CWinApp)
...
CBarPlatformApp::CBarPlatformApp()
{
	// 支持重新启动管理器
...
// 唯一的一个 CBarPlatformApp 对象

CBarPlatformApp theApp;


// CBarPlatformApp 初始化

BOOL CBarPlatformApp::InitInstance()
{
	// 防止重复运行程序
	...
	else
	{
		...
		HANDLE hSem = CreateSemaphore(&sa, 1, 1, _T("Bar_PlatForm"));
